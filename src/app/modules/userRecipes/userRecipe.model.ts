...
import { Preparation, Tingredient, TnutritionValue, TuserRecipe } from "./userRecipe.interface";
...
const userRecipeSchema = new Schema<TuserRecipe>(
  {
...
const userRecipemodel = mongoose.model<TuserRecipe>("user-recipes", userRecipeSchema);
