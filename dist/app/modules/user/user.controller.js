...
exports.updateUserController = exports.getMyProfileController = exports.getAllUserController = exports.getSingleUserController = exports.createVipUserController = exports.createchildUserController = exports.createTrailUserController = void 0;
...
exports.getSingleUserController = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.userModel.findOne({ email: req.query.email }).populate("parent_id").select("-password -isDeleted -role -createdAt -updatedAt");
    if (!user) {
...
exports.getMyProfileController = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.userModel.findOne({ email: req.user.email }).select("-password -isDeleted -role -createdAt -updatedAt");
    if (!user) {
        throw new Error("User not found");
    }
    res.status(http_status_1.default.OK).json({
